...
scenarios (5 seeds each), EcoNet achieves costs within 2\% of a
perfect-foresight Oracle, generalizes across diverse real-weather
conditions without retraining, and maintains stable performance under
forecast noise ($\sigma$ up to 4$^{\circ}$C) while MPC degrades by
