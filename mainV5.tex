...
of increasing sophistication: independent (dynamic context-dependent
preferences), aligned (with inter-agent coordination), hierarchical
...
Several patterns emerge. First, all AIF modes (Independent, Aligned,
Hierarchical, Federated, ToM) achieve comfort comparable to the No-HEMS
deadband thermostat (108.6 vs.\ 108.6~$^{\circ}$C$\cdot$h), confirming
...
Several patterns are notable. First, all AIF agents (Independent and
...
modes produce near-identical costs (Section~\ref{sec:uncertainty}),
...
Several patterns emerge. In Phoenix, where cooling runs near-continuously,
