...
of the other agent's behavior. The Independent, Aligned, and Hierarchical modes produce identical
results (\$19.54), confirming that the ToU-aware dynamic $C$ vectors
alone account for the cost performance---centralized coordination adds
no benefit when agents already adapt preferences to environmental signals.
...
From a broader perspective, a notable finding is that the three baseline
